...
<script>
    ...
    window.chat_id = Math.random()
    window.chat_name = 'USER'
    ...
    js.onload = function () {
        window.chat_iframe.style = 'width:' + window.chat_width + ';height:' + window.chat_height + ';max-width:100%;border:0px solid #CCCCCC;border-radius:5px;overflow:hidden;'
