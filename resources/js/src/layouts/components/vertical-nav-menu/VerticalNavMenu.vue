      ...
      <div @mouseenter="mouseEnter" @mouseleave="mouseLeave">
        ...
        <div class="header-sidebar flex items-end justify-between" slot="header">
          ...
          <router-link tag="div" class="vx-logo cursor-pointer flex items-center" to="/">
           <div style="position:relative; min-height: 56px"> <logo class="h-16 mr-4 fill-current text-primary" style="position:absolute; left:0px;" />
            <logo-full v-show="isMouseEnter || !reduce" class="h-16 mr-4 fill-current text-primary" style="position:absolute; left:0px;"/>
           </div>
